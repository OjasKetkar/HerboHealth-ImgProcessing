...
if(!$con)
{
 ...
 $sql = "INSERT INTO `orders` ( `username`, `email`, `phone`, `plant` ,`quantity`, `address`) VALUES ( '$name', '$email', '$phone', '$plant' ,'$quantity', '$address');";
        ...
        <div id="contact-box">
            <form action = "transaction.php"  method="post">
                ...
                <div class="formgroup">
                     ...
                     <input type="text" name="plant" id="plant" placeholder="Enter name of plants">
                </div>
                <div class="formgroup">
                     <label for="quantity">Quantity</label>
                     <input type="number" name="quantity" id="quantity" placeholder="Enter number of plants">
                </div>
                <div class="formgroup">
                ...
                <div class = "formgroup center" >
                    <a href="arrive/arrive.html">
                    <button type="submit" class="btn" value = "click" onclick = "click()">Confirm Order</button>
                    </a>
